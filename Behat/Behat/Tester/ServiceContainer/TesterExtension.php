...
namespace CanalTP\NmpAcceptanceTestBundle\Behat\Behat\Tester\ServiceContainer;
...
class TesterExtension extends BaseExtension
{
    ...
    {
        $definition = new Definition('CanalTP\NmpAcceptanceTestBundle\Behat\Behat\Tester\Runtime\RuntimeStepTester', array(
